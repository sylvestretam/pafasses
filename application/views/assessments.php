                ...
                <div class="card bg-light d-flex flex-fill">
                    ...
                    <div class="card-footer">
                        <div class="text-right">
                            ...
                            <a class="btn btn-xs btn-primary btn-flat"
                                href="<?= base_url(); ?>index.php/assessments/assessment/<?= $assessment->id_evaluation ?>">
                            ...
                            <a href="<?= base_url(); ?>index.php/rapports/rapportpdf/<?= $assessment->id_evaluation ?>"
                                target="_blank" class="btn btn-xs btn-info btn-flat">
                                <i class="nav-icon fas fa-book"></i> RAPPORT DAL
                            </a>
                            <a href="<?= base_url(); ?>index.php/rapports/rapportdcp/<?= $assessment->id_evaluation ?>"
                                target="_blank" class="btn btn-xs btn-info btn-flat">
