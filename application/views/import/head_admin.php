    ...
    <head>
        ...
        <title> DASHBOARD DCP </title>
        <link rel="icon" href="<?= base_url(); ?>public/dist/img/eneo_logo.jpg" sizes="32x32">
        <!-- Font Awesome -->
        ...
        <link rel="stylesheet"
            href="<?= base_url(); ?>public/plugins/datatables-buttons/css/buttons.bootstrap4.min.css">
